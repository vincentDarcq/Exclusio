...
function searchActor() {
    return __awaiter(this, void 0, void 0, function* () {
        const input = document.querySelector('input.searchActorSerie');
        const actors = allActors.filter(actor => actor.toLowerCase().includes(input.value.toLowerCase()));
        yield fillFiltersSeries('actors', document.querySelector('.list-actors-series'), actors);
    });
}
function searchDirector() {
    return __awaiter(this, void 0, void 0, function* () {
        const input = document.querySelector('input.searchDirectorSerie');
        const directors = allDirectors.filter(director => director.toLowerCase().includes(input.value.toLowerCase()));
        yield fillFiltersSeries('directors', document.querySelector('.list-directors-series'), directors);
    });
}
...
function fetchActorsSerie() {
    return __awaiter(this, void 0, void 0, function* () {
        const result = yield fetch(`series/acteurs`);
...
function fetchDirectorsSerie() {
    return __awaiter(this, void 0, void 0, function* () {
        const result = yield fetch(`series/realisateurs`);
        const content = yield result.json();
...
function fetchSeries(page, direction) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield fetch(`series/${filterMode === "exclusion" ? 'exclusions' : 'inclusions'}/${page}`, {
            method: 'POST',
            headers: {
