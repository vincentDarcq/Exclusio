...
public class MovieSpecifications {
    public static Specification<MovieEntity> withExclusions(List<Genres> genres, List<String> realisateurs, List<String> castings) {
    ...
    public static Specification<MovieEntity> withInclusions(List<Genres> genres, List<String> realisateurs, List<String> castings) {
        return (root, query, cb) -> {
            List<Predicate> predicates = new ArrayList<>();
